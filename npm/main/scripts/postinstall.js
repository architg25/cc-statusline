...
if (!silent) {
  console.log("🚀 Setting up cc-statusline for Claude Code...");
}
...
try {
  ...
  const packageMap = {
    ...
    "win32-ia32": "@architg25/ccline-win32-x64", // Use 64-bit for 32-bit
  };
  ...
  if (!silent) {
    console.log("✨ cc-statusline is ready for Claude Code!");
